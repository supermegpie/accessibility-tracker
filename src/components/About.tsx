    ...
    <div style={{ maxWidth: '700px', margin: '0 auto', padding: '32px 16px' }}>
      ...
      <div style={{ backgroundColor: '#00ACC1', borderRadius: '8px', padding: '28px', textAlign: 'center' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '14px', margin: '0 0 16px', lineHeight: '1.6' }}>
          The more reviews we have, the more useful this app becomes for EVERYONE. If you have visited a business recently, your review takes less than two minutes and makes a real difference for the next disabled traveler searching for that place.
        </p>
